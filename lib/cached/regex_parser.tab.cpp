...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_R_INTEGER = 3,                  /* R_INTEGER  */
  YYSYMBOL_R_GROUP_OPEN = 4,               /* "("  */
  YYSYMBOL_R_GROUP_CLOSE = 5,              /* ")"  */
  YYSYMBOL_R_STAR = 6,                     /* "*"  */
  YYSYMBOL_R_PLUS = 7,                     /* "+"  */
  YYSYMBOL_R_ANY = 8,                      /* "."  */
  YYSYMBOL_R_UNION = 9,                    /* "|"  */
  YYSYMBOL_R_OPTIONAL = 10,                /* "?"  */
  YYSYMBOL_R_QUANT_OPEN = 11,              /* "{"  */
  YYSYMBOL_R_QUANT_CLOSE = 12,             /* "}"  */
  YYSYMBOL_R_COMMA = 13,                   /* ","  */
  YYSYMBOL_R_CLASS_OPEN = 14,              /* "["  */
  YYSYMBOL_R_CLASS_CLOSE = 15,             /* "]"  */
  YYSYMBOL_R_CLASS_RANGE = 16,             /* "-"  */
  YYSYMBOL_R_CLASS_NEG = 17,               /* "^"  */
  YYSYMBOL_R_IDENTIFIER = 18,              /* R_IDENTIFIER  */
  YYSYMBOL_YYACCEPT = 19,                  /* $accept  */
  YYSYMBOL_regex = 20,                     /* regex  */
...
yy_symbol_value_print (FILE *yyo,
                       yysymbol_kind_t yykind, YYSTYPE const * const yyvaluep, REContext& ctx)
{
  FILE *yyoutput = yyo;
  YY_USE (yyoutput);
  YY_USE (ctx);
...
yydestruct (const char *yymsg,
            yysymbol_kind_t yykind, YYSTYPE *yyvaluep, REContext& ctx)
{
  YY_USE (yyvaluep);
  YY_USE (ctx);
  if (!yymsg)
  ...
  case 16: /* atom: "[" set_items "]"  */
    {
      ...
      for(auto i : *(yyvsp[-1].setValue)) {
        v.push_back(i);
      }
      delete (yyvsp[-1].setValue);
      (yyval.rValue) = new REG(IntArgs(v));
    }
    break;
  ...
  case 17: /* atom: "[" "^" set_items "]"  */
    {
      ...
      std::set_difference(
        ...
        (yyvsp[-1].setValue)->begin(), (yyvsp[-1].setValue)->end(),
        std::inserter(diff, diff.begin())
      );
      delete (yyvsp[-1].setValue);
      (yyval.rValue) = new REG(IntArgs(diff));
    }
    break;
  ...
  case 20: /* set_items: set_item set_items  */
    {
      ...
      for (auto i : *(yyvsp[0].setValue)) {
        (yyvsp[-1].setValue)->insert(i);
      }
      delete (yyvsp[0].setValue);
    }
    break;

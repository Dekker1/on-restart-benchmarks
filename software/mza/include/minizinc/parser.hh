...
public:
  ParserState(const std::string& f, const std::string& b, std::ostream& err0,
              ...
              MiniZinc::Model* model0, bool isDatafile0, bool isFlatZinc0, bool parseDocComments0)
      : filename(f.c_str()),
        buf(b.c_str()),
        pos(0),
...
Model* parseFromString(Env& env, const std::string& model, const std::string& filename,
                       const std::vector<std::string>& includePaths, bool ignoreStdlib,

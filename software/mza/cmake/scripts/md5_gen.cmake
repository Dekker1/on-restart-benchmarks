...
if(FORCE OR (NOT "${mza_lexer_lxx_md5}" STREQUAL "${mza_lexer_lxx_md5_cached}"))
    file(COPY "${PROJECT_BINARY_DIR}/mza_lexer.yy.cpp" DESTINATION "${PROJECT_SOURCE_DIR}/lib/cached")
endif()
if(FORCE OR (NOT "${mza_parser_yxx_md5}" STREQUAL "${mza_parser_yxx_md5_cached}"))
    file(COPY "${PROJECT_BINARY_DIR}/mza_parser.tab.cpp" DESTINATION "${PROJECT_SOURCE_DIR}/lib/cached")
    file(COPY "${PROJECT_BINARY_DIR}/include/minizinc/support/mza_parser.tab.hh" DESTINATION "${PROJECT_SOURCE_DIR}/lib/cached/minizinc/support")
endif()

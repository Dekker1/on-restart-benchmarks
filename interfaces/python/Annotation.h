...
/*inline Expression* MznObject_get_e(MznAnnotation* self) { return
MznObject_get_e(reinterpret_cast<MznExpression*>(self)); } inline void
MznObject_set_e(MznAnnotation* self, Expression* e0) {
MznObject_set_e(reinterpret_cast<MznExpression*>(self), e0); }*/
...
static PyTypeObject MznAnnotation_Type = {
    PyVarObject_HEAD_INIT(NULL, 0) "minizinc.Annotation", /* tp_name */
